...
function MappingLayout() {
  ...
  return (
    <div className="min-h-[100dvh] bg-white md:flex md:min-h-[calc(100vh-6rem)] md:flex-col md:items-center md:justify-center md:gap-5 md:bg-[#f1f7fb] md:px-3 md:py-6">
      ...
      <div
        className={[
          ...
          isTabletPreview
            ? "md:h-[820px] md:max-h-[88vh] md:max-w-[820px] md:rounded-[38px] md:bg-[#f3f4f6] md:p-[3px] md:shadow-[0_34px_80px_rgba(15,23,42,0.24),inset_0_0_4px_rgba(0,0,0,0.1)] md:ring-1 md:ring-slate-300"
            : "md:h-[820px] md:max-h-[88vh] md:max-w-[430px] md:rounded-[46px] md:bg-black md:p-[7px] md:shadow-[0_34px_80px_rgba(15,23,42,0.24),inset_0_0_4px_rgba(255,255,255,0.24)] md:ring-1 md:ring-slate-300",
        ].join(" ")}
      >
